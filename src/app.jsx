...
Para "purchased_by_raw": no app da Apple Card, cada transação tem uma linha embaixo tipo "Aline — 2 hours ago" ou "McKinney, TX \n Aline — Yesterday" — o nome ANTES do travessão "—" é quem fez a compra. Se não tiver nome antes do travessão (só "Yesterday", "Tuesday", "Pending", etc. sozinho), significa que foi o titular principal do cartão, e nesse caso "purchased_by_raw" deve ser null. Copie o texto DEPOIS do travessão (o "2 hours ago", "Yesterday", etc.) como "date_raw".
